...
The CLI uses Chrome/Chromium via CDP directly. The binary `agent-browser` is already installed and available on PATH.
...
agent-browser --profile ~/.local/share/agent-browser/profile open https://app.example.com/login
# ... fill credentials, submit ...

# All future runs: already authenticated
agent-browser --profile ~/.local/share/agent-browser/profile open https://app.example.com/dashboard
```
...
**Option 3: Auth vault (credentials stored encrypted, login by name)**
